...
router.get('/', (req, res, next) =>{
	...
	let place_name = req.params.place_name;
	//let place_description = req.params.place_description;
	...
	connection.query(`CALL get_email_from_session_id('${req.params.session_id}')`, (err, results, fields) =>{
		...
		connection.query(`CALL create_place('${results[0][0].email_address}', '${place_name}')`, (err, results, fields) =>{
			if(err) return res.send(404, 'Not Found');
